...
\end{tikzpicture}
\caption{Software Warp Specialization Architecture on Turing. Producer warps fetch packed weights from DRAM and dequantize into circular SMEM; consumer warps execute WMMA matrix multiplication without block-wide barrier stalls.}
\label{fig:warp_spec}
\end{figure}
...
\end{axis}
\end{tikzpicture}
\caption{SM Boost Clock Behavior on Physical Tesla T4. Capping occupancy at 25\% maintains flat 50.36W power and locks peak 1590 MHz clocks.}
